...
var centerMenu = [
    ...
    ,{
        name: '我发布的失物信息',
        url: '../shiwuzhaoling/list2.html'
    }
    ,{
        name: '失物认领',
        url: '../shiwuzhaolingYuyue/list.html'
    }
    ,{
        name: '我发布的寻物启事',
        url: '../xunwuqishi/list2.html'
    }
    ,{
        name: '寻物启事留言',
        url: '../xunwuqishiLiuyan/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '寻物启事',
        url: './pages/xunwuqishi/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/xiaoyuanshiwu/admin/dist/index.html#/login";
