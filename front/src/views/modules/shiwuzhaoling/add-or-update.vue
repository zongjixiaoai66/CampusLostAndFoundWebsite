        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="认领状态" prop="renlingzhuangtaiTypes">
                        <el-select v-model="ruleForm.renlingzhuangtaiTypes" :disabled="ro.renlingzhuangtaiTypes" placeholder="请选择认领状态">
                            <el-option
                                v-for="(item,index) in renlingzhuangtaiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shiwuzhaolingPhoto" label="物品图片" prop="shiwuzhaolingPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.shiwuzhaolingPhoto?$base.url+ruleForm.shiwuzhaolingPhoto:''"
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.shiwuzhaolingTime"  class="input" label="拾遗时间" prop="shiwuzhaolingTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.shiwuzhaolingTime"
                                type="datetime"
                                placeholder="拾遗时间"
                                :disabled="ro.shiwuzhaolingTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.shiwuzhaolingContent"  label="详情" prop="shiwuzhaolingContent">
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    shiwuzhaolingUuidNumber: true,
                    shiwuzhaolingName: false,
                    shiwuzhaolingTypes: false,
                    renlingzhuangtaiTypes: false,
                    yonghuId: false,
                ...
                rules: {
                   ...
                   renlingzhuangtaiTypes: [
                              { required: true, message: '认领状态不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=renlingzhuangtai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.renlingzhuangtaiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.shiwuzhaolingContent = _this.ruleForm.shiwuzhaolingContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.shiwuzhaolingContent = this.ruleForm.shiwuzhaolingContent.replaceAll(this.$base.url,"");
                        this.$http({
