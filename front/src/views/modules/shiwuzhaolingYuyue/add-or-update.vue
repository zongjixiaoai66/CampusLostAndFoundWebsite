<template>
    <div class="addEdit-block">
        <el-form
                ...
                >
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='shiwuzhaoling'">
                    <el-form-item class="select" v-if="type!='info'"  label="失物信息" prop="shiwuzhaolingId">
                        <el-select v-model="ruleForm.shiwuzhaolingId" :disabled="ro.shiwuzhaolingId" filterable placeholder="请选择失物信息" @change="shiwuzhaolingChange">
                            <el-option
                                    v-for="(item,index) in shiwuzhaolingOptions"
                                    v-bind:key="item.id"
                                    :label="item.shiwuzhaolingName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='shiwuzhaoling' ">
                    <el-form-item class="input" v-if="type!='info'"  label="失物编号" prop="shiwuzhaolingUuidNumber">
                        <el-input v-model="shiwuzhaolingForm.shiwuzhaolingUuidNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='shiwuzhaoling' ">
                    <el-form-item class="input" v-if="type!='info'"  label="物品名称" prop="shiwuzhaolingName">
                        <el-input v-model="shiwuzhaolingForm.shiwuzhaolingName"
                ...
                <el-col :span="12"  v-if="sessionTable !='shiwuzhaoling' ">
                    <el-form-item class="input" v-if="type!='info'"  label="物品类型" prop="shiwuzhaolingValue">
                        <el-input v-model="shiwuzhaolingForm.shiwuzhaolingValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='shiwuzhaoling' ">
                    <el-form-item class="input" v-if="type!='info'"  label="认领状态" prop="renlingzhuangtaiValue">
                        <el-input v-model="shiwuzhaolingForm.renlingzhuangtaiValue"
                                  placeholder="认领状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="认领状态" prop="renlingzhuangtaiValue">
                            <el-input v-model="ruleForm.renlingzhuangtaiValue"
                                      placeholder="认领状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="sessionTable !='shiwuzhaoling' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shiwuzhaolingPhoto" label="物品图片" prop="shiwuzhaolingPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (shiwuzhaolingForm.shiwuzhaolingPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shiwuzhaolingPhoto" label="物品图片" prop="shiwuzhaolingPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.shiwuzhaolingPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='shiwuzhaoling' ">
                    <el-form-item class="input" v-if="type!='info'"  label="拾遗时间" prop="shiwuzhaolingTime">
                        <el-input v-model="shiwuzhaolingForm.shiwuzhaolingTime"
                                  placeholder="拾遗时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="拾遗时间" prop="shiwuzhaolingTime">
                            <el-input v-model="ruleForm.shiwuzhaolingTime"
                ...
                <el-col :span="12"  v-if="sessionTable !='shiwuzhaoling' ">
                    <el-form-item class="input" v-if="type!='info'"  label="拾遗地址" prop="shiwuzhaolingDizhi">
                        <el-input v-model="shiwuzhaolingForm.shiwuzhaolingDizhi"
                                  placeholder="拾遗地址" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="认领凭证" prop="shiwuzhaolingYuyueText">
                        <el-input type="textarea"  :readonly="ro.shiwuzhaolingYuyueText" v-model="ruleForm.shiwuzhaolingYuyueText" placeholder="认领凭证"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shiwuzhaolingYuyueText" label="认领凭证" prop="shiwuzhaolingYuyueText">
                            <span v-html="ruleForm.shiwuzhaolingYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shiwuzhaolingYuyueYesnoTypes" label="审核" prop="shiwuzhaolingYuyueYesnoTypes">
                        <el-input v-model="ruleForm.shiwuzhaolingYuyueYesnoValue" placeholder="审核" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shiwuzhaolingYuyueYesnoText" label="详情" prop="shiwuzhaolingYuyueYesnoText">
                        <span v-html="ruleForm.shiwuzhaolingYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    shiwuzhaolingId: false,
                    yonghuId: false,
                    shiwuzhaolingYuyueText: false,
                    shiwuzhaolingYuyueYesnoTypes: false,
                    shiwuzhaolingYuyueYesnoText: false,
                    insertTime: false,
                },
                ruleForm: {
                    shiwuzhaolingId: '',
                    ...
                    shiwuzhaolingYuyueYesnoTypes: '',
                    shiwuzhaolingYuyueYesnoText: '',
                    insertTime: '',
                },
                shiwuzhaolingYuyueYesnoTypesOptions : [],
                shiwuzhaolingOptions : [],
                yonghuOptions : [],
                rules: {
                   shiwuzhaolingId: [
                              { required: true, message: '失物id不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   shiwuzhaolingYuyueText: [
                              { required: true, message: '认领凭证不能为空', trigger: 'blur' },
                          ],
                   shiwuzhaolingYuyueYesnoTypes: [
                   ...
                   insertTime: [
                              { required: true, message: '认领时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shiwuzhaoling_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shiwuzhaolingYuyueYesnoTypesOptions = data.data.list;
                    }
                });

         this.$http({
             url: `shiwuzhaoling/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.shiwuzhaolingOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            shiwuzhaolingChange(id){
                this.$http({
                    url: `shiwuzhaoling/info/`+id,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shiwuzhaolingForm = data.data;
                    }
                });
            },
            yonghuChange(id){
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `shiwuzhaolingYuyue/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.shiwuzhaolingChange(data.data.shiwuzhaolingId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shiwuzhaolingYuyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shiwuzhaolingYuyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
