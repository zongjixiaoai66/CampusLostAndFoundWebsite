               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物品名称" prop="xunwuqishiName">
                       <el-input v-model="ruleForm.xunwuqishiName"
                                 placeholder="物品名称" clearable  :readonly="ro.xunwuqishiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="物品类型" prop="shiwuzhaolingTypes">
                        <el-select v-model="ruleForm.shiwuzhaolingTypes" :disabled="ro.shiwuzhaolingTypes" placeholder="请选择物品类型">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="找回状态" prop="zhaohuizhuangtaiTypes">
                        <el-select v-model="ruleForm.zhaohuizhuangtaiTypes" :disabled="ro.zhaohuizhuangtaiTypes" placeholder="请选择找回状态">
                            <el-option
                                v-for="(item,index) in zhaohuizhuangtaiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="找回状态" prop="zhaohuizhuangtaiValue">
                        <el-input v-model="ruleForm.zhaohuizhuangtaiValue"
                            placeholder="找回状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xunwuqishiPhoto" label="物品图片" prop="xunwuqishiPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.xunwuqishiPhoto?$base.url+ruleForm.xunwuqishiPhoto:''"
                            @change="xunwuqishiPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xunwuqishiPhoto" label="物品图片" prop="xunwuqishiPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.xunwuqishiPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.xunwuqishiTime"  class="input" label="丢失时间" prop="xunwuqishiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.xunwuqishiTime"
                                type="datetime"
                                placeholder="丢失时间"
                                :disabled="ro.xunwuqishiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xunwuqishiTime" label="丢失时间" prop="xunwuqishiTime">
                            <span v-html="ruleForm.xunwuqishiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="丢失地址" prop="xunwuqishiDizhi">
                       <el-input v-model="ruleForm.xunwuqishiDizhi"
                                 placeholder="丢失地址" clearable  :readonly="ro.xunwuqishiDizhi"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.xunwuqishiContent"  label="详情" prop="xunwuqishiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xunwuqishiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xunwuqishiContent" label="详情" prop="xunwuqishiContent">
                            <span v-html="ruleForm.xunwuqishiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    xunwuqishiName: false,
                    shiwuzhaolingTypes: false,
                    zhaohuizhuangtaiTypes: false,
                    xunwuqishiPhoto: false,
                    xunwuqishiTime: false,
                    yonghuId: false,
                    xunwuqishiDizhi: false,
                    xunwuqishiContent: false,
                },
                ruleForm: {
                    xunwuqishiName: '',
                    shiwuzhaolingTypes: '',
                    zhaohuizhuangtaiTypes: '',
                    xunwuqishiPhoto: '',
                    xunwuqishiTime: '',
                    yonghuId: '',
                    xunwuqishiDizhi: '',
                ...
                rules: {
                   ...
                   zhaohuizhuangtaiTypes: [
                              { required: true, message: '找回状态不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   xunwuqishiDizhi: [
                              { required: true, message: '丢失地址不能为空', trigger: 'blur' },
                          ],
                   xunwuqishiContent: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhaohuizhuangtai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zhaohuizhuangtaiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.xunwuqishiContent = _this.ruleForm.xunwuqishiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.xunwuqishiContent = this.ruleForm.xunwuqishiContent.replaceAll(this.$base.url,"");
                        this.$http({
            ...
            //图片
            xunwuqishiPhotoUploadChange(fileUrls){
                this.ruleForm.xunwuqishiPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
