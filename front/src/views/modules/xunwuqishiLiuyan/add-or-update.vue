            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='xunwuqishi'">
                    <el-form-item class="select" v-if="type!='info'"  label="寻物启事" prop="xunwuqishiId">
                        <el-select v-model="ruleForm.xunwuqishiId" :disabled="ro.xunwuqishiId" filterable placeholder="请选择寻物启事" @change="xunwuqishiChange">
                            <el-option
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.xunwuqishiId = true;//物品
                this.ro.yonghuId = true;//用户
                this.ro.xunwuqishiLiuyanText = true;//留言内容
            }else{
            }
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.xunwuqishiChange(data.data.xunwuqishiId)
